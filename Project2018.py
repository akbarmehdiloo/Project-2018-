...
iris_cols=['Petal Length', 'Petal Width', 'Sepal Length','Sepal Width','Class'] #The raw data from UCI doesn't contain column name, this line will give a name to each of the columns
